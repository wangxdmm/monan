...
export type ICodeHandlerParam<T> = {
  code: number | string;
  error: AxiosError;
...
export type DynamicRequestConfig<T, R = any> = {
...
export type MessageTip = (messageOrOptions?: string | Partial<MessageOptions>) => void;
...
export type defineAPI<Id, Data = any, Response = any> = {
  id: Id;
  data: Data;
  response: Response;
};
