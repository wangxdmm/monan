...
export class DeprecatedRestful<T> extends Restful<T> {
  ...
  get<Result = any, RequestParam = any>(urlIn: string, params?: RequestParam, config?: Config) {
  ...
  delete<Result = any, RequestParam = any>(urlIn: string, body: RequestParam, config?: Config) {
  ...
  post<Result = any, RequestParam = any>(urlIn: string, body: RequestParam, config?: Config) {
    const { url, dataOrParams } = this.normalizeRequest(urlIn, body, config)
  ...
  put<Result = any, RequestParam = any>(urlIn: string, body: RequestParam, config?: Config) {
    const { url, dataOrParams } = this.normalizeRequest(urlIn, body, config)
  ...
  patch<Result = any, RequestParam = any>(urlIn: string, body: RequestParam, config?: Config) {
    const { url, dataOrParams } = this.normalizeRequest(urlIn, body, config)
