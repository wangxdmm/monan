...
describe('restful', async () => {
  beforeEach(() => {
    const easyAxios = defineEasyAxios<'tokenOutDate'>({
    ...
    moxios.install(easyAxios.http.instance)
